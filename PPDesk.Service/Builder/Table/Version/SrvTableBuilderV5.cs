...
{
    public interface ISrvTableBuilderV5 : IForServiceCollectionExtension
    {
        SrvTable TableByTickeClassBuilder(SrvETicketClass eTicketClass);
    }

    public class SrvTableBuilderV5 : ISrvTableBuilderV5
    {
        public SrvTableBuilderV5() { }
        ...
        public SrvTable TableByTickeClassBuilder(SrvETicketClass eTicketClass)
        {
            ...
            builder.GdrName = GdrNameBuilder(eTicketClass.Description, builder.Type);
        ...
        {
            description = description.Substring(0, description.Length - description.LastIndexOf("-") - 2);
